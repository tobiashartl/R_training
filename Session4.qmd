...
- Advantages: flexibile, consistent syntax, and fancy graphics.
...
## Example: Scatterplot of temperatures in Maastricht
- We will make a similar plot to exercise 4.3 a scatterplot of temperatures in Maastricht
...
ggplot(wide_data, aes(x = index, y = MAASTRICHT)) +
  geom_line(color = "steelblue", size = 1) # adds lines
```
...
```
## Exercise 4.5: Use other packages for plots
